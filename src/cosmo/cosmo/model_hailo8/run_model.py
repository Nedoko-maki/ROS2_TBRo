...
from cosmo.rpio import relpath
...
def post_processing(i, logits):
    fp_output_path = "./output_images"
    im = Image.fromarray(np.squeeze(logits).astype(np.uint8), mode='L')
    output_path = fp_output_path if fp_output_path else '.'
...
def run_example():
    ...
    fp_left = relpath("./input_images/left.jpg")
    fp_right = relpath("./input_images/right.jpg")
    fp_hef = "/home/cosmo/Documents/ros2_ws/src/cosmo/cosmo/model/run_model.py"
    ...
    load_input_images(fp_right, fp_left, images)
